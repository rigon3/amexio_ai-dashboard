...
5. For budget forecasting, add a serialized model at backend/models/training_budget_forecast.pkl or set TRAINING_BUDGET_MODEL_PATH before starting the backend
6. Call GET /forecast to read the current forecast payload